...
The **gravestone icon** is always visible in the Chrome extension.  

**Single-click interaction:**  
- On one user’s computer, clicking the gravestone triggers a ghost animation on the other user’s screen (shake + glow).  
